...
<?php include(ROOT_PATH . "/app/Includes/adminsidebar.php"); ?>
      ...
      <div class="admin-content">
        ...
        <div class="content">
          ...
          <div>
              <label>Email</label>
              <input type="email" name="email" value="<?php echo $email; ?>"class="text-input" class="text-input">
          </div>
          <div>
              <label>Password</label>
              <input type="password" name="password" value="<?php echo $password; ?>" class="text-input" class="text-input" class="text-input">
          </div>
          <div>
              <label>Password Confirmation</label>
              <input type="password" name="passwordConf" value="<?php echo $passwordConf; ?>" class="text-input" class="text-input">
          </div>
          <div>
